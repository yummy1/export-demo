<template>
  <div v-loading.lock="fullscreenLoading" element-loading-text="Efforts to generate PDF">
    <el-form v-if="!isComponents" :inline="true" class="demo-form-inline">
      <el-form-item>
        <el-button type="primary" @click="onExportPDF1">导出PDF1</el-button>
      </el-form-item>
    </el-form>
    <div id="pdfDom" class="content-container">
