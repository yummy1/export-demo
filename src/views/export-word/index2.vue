<template>
  <div class="app-container">
    ...
    <p class="work">技术方案：mhtml-to-word</p>
    <p class="result-info">结果：基本实现，但样式失效</p>
    <div id="word">
      <!-- 报价容器 -->
...
export default {
  ...
  methods: {
    ...
    exportWord: function() {
      ...
      exportWord({
        selector: '#word',
        style: '*{margin:0;padding:0;font-size:12px;font-family:"微软雅黑","宋体";list-style:none;box-sizing:border-box}// 清除浮动 .clearfix:after{content:"";height:0;line-height:0;display:block;clear:both;visibility:hidden}.clearfix{zoom:1}.quote_info{width:800px;margin:0 auto}.quote_itemBox{float:left;width:100%;margin-bottom:20px}.quote_item{float:left;width:50%;display:flex}.quote_label{width:100px;text-align:right;line-height:32px}.quote_p{flex:1;line-height:32px}.h3_title{float:left;width:100%;font-size:20px;line-height:40px;text-align:center;margin-bottom:30px}.quote_table{padding:0 20px}.table_domQuote .quoteTable{display:flex;align-items:center;justify-content:flex-end;font-size:14px;padding-right:30px;height:50px}.reasonBox{padding:0 20px 20px 20px}.title_checkReason{line-height:50px}.checkReasonMain .p_box{border:1px solid #ebeef5;padding:10px 20px}.p_checkReason{height:30px;line-height:30px}',
        filename: 'exportWord2'
      })
